...
var side[ ];   // variable to hold the measurement of the sides of a right triangular prism.
...
side[index] = prompt("Please enter side one, the length:  ")    // Enter the value for the measurement of
